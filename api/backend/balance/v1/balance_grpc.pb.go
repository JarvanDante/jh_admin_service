...
const (
	...
	Balance_GetChangeList_FullMethodName           = "/balance.Balance/GetChangeList"
	...
	Balance_GetManualList_FullMethodName           = "/balance.Balance/GetManualList"
)
...
type BalanceClient interface {
	...
	// 交易类型选项
	GetChangeList(ctx context.Context, in *GetChangeListReq, opts ...grpc.CallOption) (*GetChangeListRes, error)
	// 充值记录相关
	...
	// 操作类型选项
	GetManualList(ctx context.Context, in *GetManualListReq, opts ...grpc.CallOption) (*GetManualListRes, error)
}
...
func (c *balanceClient) GetChangeList(ctx context.Context, in *GetChangeListReq, opts ...grpc.CallOption) (*GetChangeListRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetChangeListRes)
	err := c.cc.Invoke(ctx, Balance_GetChangeList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *balanceClient) GetManualList(ctx context.Context, in *GetManualListReq, opts ...grpc.CallOption) (*GetManualListRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetManualListRes)
	err := c.cc.Invoke(ctx, Balance_GetManualList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BalanceServer interface {
	...
	// 交易类型选项
	GetChangeList(context.Context, *GetChangeListReq) (*GetChangeListRes, error)
	// 充值记录相关
	...
	// 操作类型选项
	GetManualList(context.Context, *GetManualListReq) (*GetManualListRes, error)
...
func (UnimplementedBalanceServer) GetChangeList(context.Context, *GetChangeListReq) (*GetChangeListRes, error) {
	return nil, status.Error(codes.Unimplemented, "method GetChangeList not implemented")
}
...
func (UnimplementedBalanceServer) GetManualList(context.Context, *GetManualListReq) (*GetManualListRes, error) {
	return nil, status.Error(codes.Unimplemented, "method GetManualList not implemented")
}
...
func _Balance_GetChangeList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetChangeListReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BalanceServer).GetChangeList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Balance_GetChangeList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BalanceServer).GetChangeList(ctx, req.(*GetChangeListReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Balance_GetManualList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetManualListReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BalanceServer).GetManualList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Balance_GetManualList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BalanceServer).GetManualList(ctx, req.(*GetManualListReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Balance_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Balance_GetChangeList_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _Balance_GetManualList_Handler,
		},
	},
